...
let questions = [
  {
    "question": "Which of the following are challenges for customers related to landscape complexity?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following are challenges for customers related to technological innovation?<br>There are two correct answers.",
    "options": [
      "Fostering Agility",
  ...
  {
    "question": "Which of the following are challenges for customers related to business change?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following does SAP recommend that customers choose from when deciding which SAP S/4HANA Cloud implementation approach to take?<br>There are three correct answers.",
    "options": [
      "New implementation",
      "System conversion",
  ...
  {
    "question": "Which of the following are dimensions of clean core?<br>There are three correct answers.",
    "options": [
      "Procedures",
      "Extensibility",
      "Integrations",
  ...
  {
    "question": "Which of the following are benefits of clean core for users?<br>There are three correct answers.",
    "options": [
      "Performance",
      "Cleansed data",
      "System reliability",
  ...
  {
    "question": "Which of the following are benefits of clean core for IT?<br>There are three correct answers.",
    "options": [
      "Software stack",
  ...
  {
    "question": "Which of the following are benefits of clean core for companies?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following are ways to get and keep operations clean?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following are definitions of \"data\" in the context of SAP S/4HANA Cloud?<br>There are three correct answers.",
    "options": [
      "Configuration",
      "Master",
      "Transactional",
  ...
  {
    "question": "Which of the following are tools that can be used during implementation projects to help achieve a clean core?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following are ways to get and keep integrations clean?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following are ways to get and keep extensions clean?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following are ways to get and keep business processes clean?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following statements about the Composable Storefront are correct?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "Which tools are required during the development of the Composable Storefront?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "Which Web service API is used by the Composable Storefront to communicate with SAP Commerce Cloud?<br>Choose the correct answer.",
    "options": [
      "SOAP",
      "ODATA",
      "RESTful",
  ...
  {
    "question": "Which statements about the Composable Storefront Routing are correct?<br>There are two correct answers.",
    "options": [
      "It supports SEO.",
  ...
  {
    "question": "Which of the following features are provided out-of-the-box by the Composable Storefront?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "What are the characteristics of a customization?​<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "How would you go about creating a variation in an existing customization?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following statements are true regarding the configuration of the customer experience calculation process?​<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "How does a user become affiliated with a segment?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "How can the SAP Commerce Cloud shopping experience be personalized for customers?<br>There are two correct answers.",
    "options": [
      "CMS Restrictions",
      "Segmentation",
      "Workflows",
  ...
  {
    "question": "Which of the following statements about search operations based on Flexible Search are correct?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following statements about the Search API are correct?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "Which indexing operations are supported by Solr?<br>There are two correct answers.",
    "options": [
      "ALL",
      "UPDATE",
      "PARTIAL_UPDATE",
  ...
  {
    "question": "You configured an indexed property of type \"text\" in your Solr index. Which of the following statements about Solr searches for that property are correct?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "Using SmartEdit, which settings are configurable in the Search Text Box?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following statements are correct regarding the merging principles of search profiles?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following statements are correct about personalized search profiles?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "What configurations are possible in a Search Profile?<br>There are three correct answers.",
    "options": [
      "Facets",
  ...
  {
    "question": "Which search profile types are supported in the Adaptive Search module?​<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "In which Backoffice cockpit can you create search profiles?<br>There are two correct answers.",
    "options": [
      "Product Cockpit",
  ...
  {
    "question": "How can you activate a Search Profile?​<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following properties are mandatory for a promotion rule to be active on a storefront?<br>There are three correct answers.",
    "options": [
      "Rule Group",
      "Web site",
      "Priority",
  ...
  {
    "question": "You must create two promotions with the requirement that if promotion A is fired, promotion B must not be fired. What do you do?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "After a promotion rule is created in Backoffice, in what format is the corresponding source rule stored in the database?<br>Choose the correct answer.",
    "options": [
      "JSON",
      "XML",
      "ImpEx",
  ...
  {
    "question": "Which of the following rule-aware objects (RAOs, that is, conditions or actions) are provided in the promotion module out of the box?<br>There are three correct answers.",
    "options": [
      "Product RAO",
      "Web site RAO",
      "Newsletter RAO",
  ...
  {
    "question": "What are the typical steps to implement a new condition type before enabling it in the rule builder in Backoffice?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "What can you configure in a Multi-Code Coupon in Backoffice?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "If you want to redeem a multi-code coupon on the storefront, what typical steps must you perform?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "What are the out-of-the-box conditions that you can combine with a coupon in a promotion?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "What factors must you consider when you use a customer coupon?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "What can you configure in a Single-Code Coupon in Backoffice?​<br>There are two correct answers.",
    "options": [
      "Maximum redemptions per customer.",
  ...
  {
    "question": "We can use @CacheControl to annotate the controller class for managing caching. Which of the following directive-descriptions are correct when using the annotation?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "What are the major features and benefits of the OCC module?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "What should we pay attention to when working with an OCC extension?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "How do we use the access control roles to restrict access to commerce process or data via OCC customization?<br>Choose the correct answer.",
    "options": [
  ...
  {
    "question": "What are the typical approaches to define data mappings from a DTO/Model to a WsDTO?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "How can SAP Commerce Integration API Module integrations be configured?<br>Choose the correct answer.",
    "options": [
  ...
  {
    "question": "Where can the JDBC logging be enabled or disabled?​<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "From version 2211 onwards, SAP Commerce Cloud is and will be versionless. What does that mean?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "Where can more resources (regarding SAP Commerce Cloud) be found?<br>There are three correct answers.",
    "options": [
      "Backoffice",
  ...
  {
    "question": "To assure GDPR compliance in SAP Commerce Cloud, which of the following features are implemented and provided out of the box?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following public code repositories are supported?<br>There are three correct answers.",
    "options": [
      "SourceForge",
      "GitHub",
      "AWS CodeCommit",
  ...
  {
    "question": "How does the Cloud Portal determine the version of SAP Commerce Cloud to use when building your project?<br>Choose the correct answer.",
    "options": [
  ...
  {
    "question": "What are the capabilities of the SAP Cloud Portal?<br>There are three correct answers.",
    "options": [
      "Monitor performance",
  ...
  {
    "question": "What information do you need to provide when deploying a build?<br>There are three correct answers.",
    "options": [
      "The deployment type",
  ...
  {
    "question": "How does the builder in SAP Cloud Portal identify what to incorporate in a build?<br>Choose the correct answer.",
    "options": [
  ...
  {
    "question": "What does Spring Security manage in SAP Commerce Cloud?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "What does an item-based restriction consist of?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following principals can be removed without a problem?<br>There are two correct answers.",
    "options": [
      "anonymous​",
      "admingroup​",
      "admin",
  ...
  {
    "question": "What are the out-of-the-box password security policies in SAP Commerce Cloud?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "About the security mechanism: type-based access rights, which of the following statements are correct?​<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "Which methods need to be coded when implementing TransactionAwareEvent?<br>There are two correct answers.",
    "options": [
      "canPublish()",
      "publishOnCommitOnly()",
      "getId()",
  ...
  {
    "question": "Which method needs to be overridden when implementing the ClusterAwareEvent interface<br>Choose the correct answer.",
    "options": [
  ...
  {
    "question": "Which of the following statements about event systems are correct?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "Which Service is used to publish an event?<br>Choose the correct answer.",
    "options": [
      "EventService",
      "ModelService",
  ...
  {
    "question": "Which of the following statements about asynchronous events are correct?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following statements about the process engine are correct?​<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "What should you consider when implementing a business process template?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following node types are predefined in the business process engine?<br>There are two correct answers.",
    "options": [
      "Action node",
      "End node",
      "Start node",
  ...
  {
    "question": "Which of these statements correctly describe actions in the process engine?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "Which service is used to create and start a business process based on a specific business process template?<br>Choose the correct answer.",
    "options": [
      "ImportService",
  ...
  {
    "question": "Which Fraud Detection symptoms exist out-of-the-box? ​<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following functionalities are provided by the basecommerce extension?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following statements regarding the out-of-the-box support for Fraud Detection are correct?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following statements regarding the Payment Service Provider (PSP) integration in SAP Commerce Cloud are correct?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "What does Order Splitting in the basecommerce extension provide out-of-the-box?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "What is the essential setting needed to run a CronJob item?<br>Choose the correct answer.",
    "options": [
  ...
  {
    "question": "What is the CronJob functionality typically used for?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "What is the correct order of the steps needed to implement a new CronJob?<br>Choose the correct answer.",
    "options": [
  ...
  {
    "question": "What are the key components that interact with each other to support the execution of a CronJob?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "What are the out-of-the-box ways to start a CronJob directly?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "There are different ways to define a workflow template. Which of the following is the most efficient way?<br>Choose the correct answer.",
    "options": [
  ...
  {
    "question": "What are the key features of the Workflow module?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "A workflow can be started through APIs in the Workflow Module. Which of the following statements regarding the related API services are correct?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "Workflow is a subtype of which item type definition in the type system?<br>Choose the correct answer.",
    "options": [
      "Job",
      "CronJob",
      "WorkflowTemplate",
  ...
  {
    "question": "Activation scripts can be used to start a workflow automatically. Which of the following situations can trigger the evaluation of activation scripts?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "What is the Commerce Validation Framework capable of?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "What are the necessary steps to follow when adding a new validation constraint using the Backoffice Administration Cockpit?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "What tools/mechanisms are available for creating/editing a new constraint?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "What essential information is required when creating a new constraint?<br>There are three correct answers.",
    "options": [
  ...
  {
    "question": "What are the possible severity levels for a constraint?<br>There are two correct answers.",
    "options": [
      "Error",
      "Warning",
      "Custom",
  ...
  {
    "question": "Which of the following statements regarding page templates, pages, and components in SAP Commerce Cloud are correct?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following statements are correct about the actions that we can perform in different modes in SmartEdit?​<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "What can we do to support out-of-the-box personalization of storefront content in SAP Commerce Cloud?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following statements are correct about SAP Commerce Cloud, composable storefront?<br>There are two correct answers.",
    "options": [
  ...
  {
    "question": "Which of the following statements regarding page slots, content slots, and components in SAP Commerce Cloud are correct?<br>There are two correct answers.",
    "options": [
...
submitBtn.addEventListener('click', function() {
    ...
    if(arrayEquals(selected.sort(), q.shuffledCorrect.slice().sort())) {
        ...
        resultDiv.innerHTML = `<span class="incorrect">Incorrect. Correct answer: ${
            q.shuffledCorrect.map(i => String.fromCharCode(65 + i)).join(', ')
        }</span>`;
...
function updateCounter() {
    ...
    counterDiv.innerHTML = `<b>Questions answered correctly: ${correct} / ${total}</b>`;
}